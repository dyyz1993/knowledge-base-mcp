...
type FullConfig = AppConfig & { browser?: BrowserConfig; searchPipeline?: SearchPipelineConfig }

export default function SettingsPanel({ open, onClose }: { open: boolean; onClose: () => void }) {
  const [config, setConfig] = useState<FullConfig>({ embedding: { ...DEFAULT_EMBEDDING }, search: { ...DEFAULT_SEARCH }, browser: { ...DEFAULT_BROWSER }, searchPipeline: { ...DEFAULT_SEARCH_PIPELINE, sources: { webSearchPrime: { enabled: true }, xbrowser: { ...DEFAULT_SEARCH_PIPELINE.sources.xbrowser }, llmDirect: { ...DEFAULT_SEARCH_PIPELINE.sources.llmDirect }, plugin: { ...DEFAULT_SEARCH_PIPELINE.sources.plugin } } } })
          ...
          <section className="rounded-lg border border-zinc-800 bg-zinc-950 p-4 space-y-4">
            ...
            <div className="border-t border-zinc-800 pt-3 space-y-3">
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onChange={v => updateSPSource("webSearchPrime", { enabled: v })}
                />
              </div>
              ...
              <div className="rounded border border-zinc-800 bg-zinc-900/30 p-3 space-y-2.5">
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onChange={v => updateSPSource("xbrowser", { enabled: v })}
                  />
                </div>
                <div className="space-y-1.5">
                ...
                <div className="space-y-1.5">
                  ...
                  <Input
                    ...
                    onChange={e => updateSPSource("xbrowser", { cdpEndpoint: e.target.value })}
                ...
                <div className="flex items-center gap-4">
                  <div className="flex items-center gap-2">
                    ...
                    <Switch
                      ...
                      onChange={v => updateSPSource("xbrowser", { headless: v })}
                    />
                  </div>
                  <div className="flex items-center gap-2 flex-1">
                    ...
                    <InputNumber
                      ...
                      onChange={v => v != null && updateSPSource("xbrowser", { timeout: v })}
                      className="flex-1"
                      addonAfter="ms"
                    />
                  </div>
              ...
              <div className="rounded border border-zinc-800 bg-zinc-900/30 p-3 space-y-2.5">
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onChange={v => updateSPSource("llmDirect", { enabled: v })}
                  />
                </div>
                <div className="space-y-1.5">
                  ...
                  <Input
                    ...
                    onChange={e => updateSPSource("llmDirect", { baseUrl: e.target.value })}
                ...
                <div className="space-y-1.5">
                  ...
                  <Input
                    ...
                    onChange={e => updateSPSource("llmDirect", { apiKey: e.target.value })}
                    placeholder="sk-xxx"
                  />
                </div>
                <div className="space-y-1.5">
                  ...
                  <Input
                    ...
                    onChange={e => updateSPSource("llmDirect", { model: e.target.value })}
              ...
              <div className="rounded border border-zinc-800 bg-zinc-900/30 p-3 space-y-2.5">
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onChange={v => updateSPSource("plugin", { enabled: v })}
                  />
                </div>
                <div className="space-y-1.5">
                  ...
                  <Input.TextArea
                    ...
                    onChange={e => updateSPSource("plugin", { prompt: e.target.value })}
            ...
            <div className="space-y-1.5 border-t border-zinc-800 pt-3">
              ...
              <InputNumber
                ...
                max={100}
                value={sp.maxResults}
                onChange={v => v != null && updateSP("maxResults", v)}
                className="w-full"
              />
            </div>
          </section>
