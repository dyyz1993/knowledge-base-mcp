...
export async function handleListSessionFavorites(_req: IncomingMessage, res: ServerResponse) {
  json(res, sf.listSessionFavorites())
}

export async function handleAddSessionFavorite(req: IncomingMessage, res: ServerResponse) {
...
export async function handleDeleteSessionFavorite(req: IncomingMessage, res: ServerResponse, url: URL) {
