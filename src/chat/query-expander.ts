import { tokenize, STOP_WORDS } from "../utils/tokenizer"
...
const SYNONYMS = new Map<string, string[]>([
  ...
  ["ai-sdk", ["ai-sdk", "AI SDK", "vercel ai", "ai sdk", "vercel ai sdk"]],
  ["openai-sdk", ["openai-sdk", "OpenAI SDK", "openai node"]],
  ["hono", ["hono", "Hono", "honojs", "轻量Web框架"]],
  ["express", ["express", "Express", "expressjs", "express.js"]],
  ["fastify", ["fastify", "Fastify"]],
  ["nestjs", ["nestjs", "NestJS", "nest"]],
  ["cloudflare-workers", ["cloudflare workers", "Cloudflare Workers", "cf workers", "边缘计算"]],
  ...
  ["nestjs", ["nestjs", "NestJS", "nest"]],
  ["cloudflare-workers", ["cloudflare workers", "Cloudflare Workers", "cf workers", "边缘计算"]],
  ["huggingface", ["huggingface", "HuggingFace", "hf", "transformers"]],
  ["langchain", ["langchain", "LangChain", "langchain.js"]],
  ["embedding", ["embedding", "向量嵌入", "向量表示", "vector embedding"]],
  ["rag", ["rag", "RAG", "检索增强生成", "retrieval augmented generation"]],
  ["vercel", ["vercel", "Vercel", "vercel部署"]],
  ["supabase", ["supabase", "Supabase", "开源Firebase"]],
  ["electron", ["electron", "Electron", "桌面应用", "跨平台桌面"]],
  ["tauri", ["tauri", "Tauri", "rust桌面应用"]],
  ["rxjs", ["rxjs", "RxJS", "响应式编程", "observable"]],
...
export function expandQuery(query: string): string[] {
  ...
  const tokens = tokenize(trimmed, { lowercase: false, minTokenLength: 2 })
